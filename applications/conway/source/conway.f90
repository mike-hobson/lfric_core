...
program conway
  ...
  use conway_mod,        only: conway_required_namelists
  use conway_driver_mod, only: initialise, step, finalise
  ...
  character(*), parameter   :: program_name = "conway"
  ...
  call init_comm( "conway", modeldb )
  call get_initial_filename( filename )
  call init_config( filename, conway_required_namelists, &
