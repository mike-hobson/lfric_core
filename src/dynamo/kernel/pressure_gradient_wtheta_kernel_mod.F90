...
type, public, extends(kernel_type) :: pressure_gradient_wtheta_kernel_type
  private
...
interface pressure_gradient_wtheta_kernel_type
   module procedure pressure_gradient_wtheta_kernel_constructor
end interface

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public pressure_gradient_wtheta_code
contains

type(pressure_gradient_wtheta_kernel_type) function pressure_gradient_wtheta_kernel_constructor() result(self)
  return
    ...
    do qp2 = 1, nqp_v
      do qp1 = 1, nqp_h
        ...
        do df = 1, ndf_wtheta
          ...
          grad_theta_at_quad(:) = grad_theta_at_quad(:) + theta_e(df)*wtheta_diff_basis(:,df,qp1,qp2)
        end do
...
end subroutine pressure_gradient_wtheta_code

end module pressure_gradient_wtheta_kernel_mod
