...
!! @param[in] basis Scalar basis functions evaluated at quadrature points.
!! @param[inout] mm Mass matrix local stencil
!! @param[in] undf Number of unique degrees of freedum  for chi field
