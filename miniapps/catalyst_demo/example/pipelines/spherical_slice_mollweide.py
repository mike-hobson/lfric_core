...
# Check if VTK module contains the Geovis Core package
try:
  vtk.vtkGeoProjection()
except AttributeError:
  print("spherical_slice_mollweide.py: ERROR: VTK module does not include Geovis Core package.")
  print("Please make sure that -DModule_vtkGeovisCore=ON is set when building ParaView.")
...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      slice.SliceType.Origin = [0.0, 0.0, 1.0]
