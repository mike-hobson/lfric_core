...
# of the 3D Cartesian mesh and storing it as VTK polygonal data
# for further analysis with ParaView or Python, along with data
# fields. The pipeline also creates a rendered image of the slice
# and stores it as an image file in png format.
#
...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView.CameraPosition = [-8, 4, 1]
      renderView.CameraViewUp = [0.2, 0.6, -0.8]
      renderView.CameraParallelScale = 2.4
